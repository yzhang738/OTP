<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<MaintenanceISTMembersContactInfoViewModel>" %>
<input type="hidden" id="tabResourceId" value="<%= ViewData["resourceId"] %>" />
    <%  using (Html.BeginForm("ISTMembersContactInfoSave", "Maintenance", new { id = ViewData["resourceId"] }, FormMethod.Post))
       {
           if (Model != null)
           { %>
