...
<script type="text/javascript">
    ...
    function onResourceSpecialtyComboBound()
    {
        ...
        if (dataItem)
        {
            ...
            if (!isNewRow) editor.value(dataItem.ResourceSpecialtyId);
        }
    }
</script>
...
<%=         
    Html.Telerik().DropDownList()
        .Name("ResourceSpecialtyId")
                .DataBinding(binding => binding.Ajax().Select("ResourceSpecialtyAjax", "Shared", new { resourceType = "ATH" }))
