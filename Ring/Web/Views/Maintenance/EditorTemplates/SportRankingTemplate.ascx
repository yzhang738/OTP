...
<%= Html.DropDownList(null, new SelectList((IEnumerable)ViewData["rankings"], "Id", "Description"))%>
<script type="text/javascript">
    // find the dropdown first
    var $dropdown = $('#Ranking');
    ...
    $dropdown.val(dataItem.Ranking ? dataItem.Ranking.Id : -1);
</script>