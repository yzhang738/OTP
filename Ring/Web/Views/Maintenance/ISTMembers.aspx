<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<MaintenanceISTMembersViewModel>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Shared.MaintenanceStrings.ISTMembers_PageTitle %>: <%: ViewData["sportName"] %> - <%: Shared.MaintenanceStrings.ISTMembers_ResourceTitle %>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="container">
            ...
            .Content(() =>
                { %>
                    <div class="groupbox_600_member" style="margin:0px 0px 0px 0px">
                        <div class="groupbox_title_background gradientHToWhite">
                            <div class="groupbox_title" >
                                <%: Shared.MaintenanceStrings.MaintenanceIST_AssignSportCaption %>
                            </div>
                        </div>
                    ...
                    <div style="text-align:center; margin: 20px 10px 0px 0px" >
                        <input type="submit" value="<%: Shared.MaintenanceStrings.MaintenanceIST_AssignSportAndSave %>" onclick="SaveResource(true);$('#AssignSport').data('tWindow').close();" />
                        <input type="submit" value="<%: Shared.MaintenanceStrings.MaintenanceIST_NotAssignSportAndSave %>" onclick="SaveResource(false);$('#AssignSport').data('tWindow').close();" />
        ...
        <div>
        <% Html.Telerik().Grid<MaintenanceISTMembersGridViewModel>()
        .Name("ISTs")
        .TableHtmlAttributes(new { style = "font-size:8pt;" })
        .HtmlAttributes(new { style = "height:360px" })
        .DataKeys(keys => keys.Add(a => a.ResourceId))
        .DataBinding(dataBinding => dataBinding.Ajax()
            .Select("ISTMembersGridAjax", "Maintenance")
            .Insert("InsertISTMember", "Maintenance")
            .Update("UpdateISTMember", "Maintenance")
            .Delete("DeleteISTMember", "Maintenance")
        )
        .Pageable(paging => paging
            .PageSize(9)
            .PageTo((int)ViewData["istCurrentPage"])
        ...
        .ToolBar(commands => commands.Custom().Text(Shared.MaintenanceStrings.ExportToExcel).HtmlAttributes(new { onclick = "onExportISTMembersPageToExcel();return false;" }))
        .ClientEvents(events => events.OnEdit("onISTGridEdit")
                                      .OnSave("onISTGridSave")
                                      .OnRowSelect("onISTGridRowSelect")
        ...
        .Columns(columns =>
        {
            ...
            columns.Bound(a => a.TBD)
                ...
                .HtmlAttributes(new { style = "text-align:center" })
                .Filterable(false);
            columns.Bound(a => a.PrimaryCscName)
                //.ClientTemplate("<#= PrimaryCscName #>")
                .Width(130);
        ...
        <% Html.Telerik().TabStrip()
            ...
            .Items(tabstrip =>
            {
                tabstrip.Add()
                    ...
                    .HtmlAttributes(new { @class = "tab", url = "/Maintenance/ISTMembersGeneralInfo/", tabNumber = "1" })
                    .Content(() =>
                        {
                          %>
                            <div class="groupbox_title_background gradientHToWhite">
                ...
                tabstrip.Add()
                    ...
                    .HtmlAttributes(new { @class = "tab", url = "/Maintenance/ISTMembersContactInfo/", tabNumber = "2" })
                    .Content(() =>
                        {
                          %>
                            <div class="groupbox_title_background gradientHToWhite">
                ...
                tabstrip.Add()
                    ...
                    .HtmlAttributes(new { @class = "tab", url = "/Maintenance/ISTMembersSportsInfo/", tabNumber = "3" })
                    .Content(() =>
                        {
                          %>
                ...
                tabstrip.Add()
                    ...
                    .HtmlAttributes(new { @class = "tab", url = "/Maintenance/ISTMembersQualificationsInfo/", tabNumber = "4" })
                    .Content(() =>
                        {
                          %>
                            <div style="height: 400px">
                ...
                tabstrip.Add()
                    ...
                    .HtmlAttributes(new { @class = "tab", url = "/Maintenance/ISTMembersPoolInfo/", tabNumber = "5" })
                    .Content(() =>
                        {
                          %>
                            <div style="height: 400px">
    ...
    <script type="text/javascript">
        function onExportISTMembersPageToExcel()
        {
            var grid = $('#ISTs').data('tGrid');
            ...
            var url = "/ExportExcelButton/ExportISTMembersPageToExcel";
...
//                     .remove();
        ...
        function onISTGridSave(e)
        {
            var d = new Date();
            var refreshSeed = d.getTime();
            var values = e.values;
            var resourceType = "<%: Constant.ResourceType.ISTMembers %>";
            ...
            if (e.mode == 'insert') {
                $.ajax({
                    ...
                    success: function(promptUser)
                    {
                        ...
                        {
                            //TODO: Localize
                            var reply = confirm("<%: Shared.MaintenanceStrings.ISTMember_SaveConfirmation %>");
        ...
        function SaveResource(assignSport)
        {
            ...
            $.ajax({
                type: 'POST',
                url: '/Maintenance/InsertISTMember',
                dataType: 'json',
                ...
                success: function(result)
                {
                    ...
                    OTPAlert("<%: Shared.MaintenanceStrings.ISTMember_AddConfirmation %>");
                }
            });
        }
