<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<MaintenanceISTMembersGeneralInfoViewModel>" %>
<input type="hidden" id="tabResourceId" value="<%= ViewData["resourceId"] %>" />
    <%  using (Html.BeginForm("ISTMembersGeneralInfoSave", "Maintenance", new { id = ViewData["resourceId"] }, FormMethod.Post))
       {
           if (Model != null)
           {%>
                    ...
                    <div style="float:left; width:49%;">
                        ...
                        <div style="float:left; width:98%;margin:0px 0px 15px 0px;">
                            <div style="float:left; width:49%;">
                                ...
                                <div class="editor-field">
                                    <%: Html.DropDownList("SpecialtyId", new SelectList(Model.Specialties, "Id", "Description", Model.SpecialtyId), new { style = "width:99%;" })%>
