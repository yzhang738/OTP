<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<MaintenanceNSOMembersContactInfoViewModel>" %>
<input type="hidden" id="tabResourceId" value="<%= ViewData["resourceId"] %>" />
    <%  using (Html.BeginForm("NSOMembersContactInfoSave", "Maintenance", new { id = ViewData["resourceId"] }, FormMethod.Post))
       {
           if (Model != null)
           { %>
