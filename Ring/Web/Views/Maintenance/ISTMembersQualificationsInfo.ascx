...
<input type="hidden" id="tabResourceId" value="<%= ViewData["resourceId"] %>" />
    ...
    <% if (ViewData["resourceId"] != null)
       { %>
        ...
        <%= Html.Telerik().Grid<MaintenanceISTMembersQualificationInfoViewModel>()
            .Name("Qualifications")
            ...
            .DataBinding(dataBinding => dataBinding.Ajax()
                .Select("ISTMembersQualificationsAjax", "Maintenance")
                .Update("UpdateISTResourceQualification", "Maintenance")
                .Insert("InsertISTResourceQualification", "Maintenance")
                .Delete("DeleteISTResourceQualification", "Maintenance")
            )
