<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<MaintenanceNSOMembersGeneralInfoViewModel>" %>
<input type="hidden" id="tabResourceId" value="<%= ViewData["resourceId"] %>" />
    <%  using (Html.BeginForm("NSOMembersGeneralInfoSave", "Maintenance", new { id = ViewData["resourceId"] }, FormMethod.Post))
       {
           if (Model != null)
           {%>
