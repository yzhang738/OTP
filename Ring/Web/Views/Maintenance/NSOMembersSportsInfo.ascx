...
<input type="hidden" id="tabResourceId" value="<%= ViewData["resourceId"] %>" />
     ...
     <script type="text/javascript">
         function onExportNSOMembersSportInfoToExcel() {
             ...
             var url = "/ExportExcelButton/ExportNSOMembersSportInfoToExcel";
    ...
    <% if (ViewData["resourceId"] != null)
       { %>
        ...
        <%= Html.Telerik().Grid<MaintenanceNSOMembersSportsInfoViewModel>()
            ...
            .ToolBar(commands => commands.Custom().Text(Shared.MaintenanceStrings.ExportToExcel).HtmlAttributes(new { onclick = "onExportNSOMembersSportInfoToExcel();return false;" }))
