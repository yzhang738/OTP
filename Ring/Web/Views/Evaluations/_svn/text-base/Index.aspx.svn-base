<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<EvaluationsIndexViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Shared.EvaluationsStrings.Index_Title %>
</asp:Content>
