<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<EvaluationsMaintenanceViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Shared.EvaluationsStrings.Maintenance_Title %>
</asp:Content>
