<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<EvaluationActionItemViewModel>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Shared.EvaluationsStrings.ActionItems_Title %>
</asp:Content>
...
<div id="container">
    ...
    <%= Html.Telerik().Grid<ActionItem>()
        ...
        .Columns(columns =>
            {
                ...
                //columns.Bound(b => b.SportId).Width(100);
                columns.Bound(b => b.TypeDesc).ClientTemplate(Html.ActionLink("<#= TypeDesc  #>", "<#= ActionName  #>", "<#= ControllerName  #>", new { id = "<#= ReferenceId  #>", spillar = "<#= TypeId #>" }, null).ToHtmlString()).ReadOnly();
        ...
        .DataBinding(dataBinding => dataBinding.Ajax()
                        .Select("GetActionItemsAjax", "Evaluations")
                        .Update("UpdateActionItemAjax", "Evaluations"))
...
<asp:Content ID="Content7" ContentPlaceHolderID="YearSelectionContent" runat="server">
    <% Html.RenderPartial("~/Views/Evaluations/ActionItemStatusSelector.ascx", Model); %>
</asp:Content>
