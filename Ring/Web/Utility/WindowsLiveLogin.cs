...
namespace OTP.Ring.Web.Utility
{
    ...
    public class WindowsLiveLogin
    {
        ...
        public WindowsLiveLogin(bool loadAppSettings)
        {
            ...
            AppId = ExtensionMethods.GetConfigurationSetting("wll_appid");
            Secret = ExtensionMethods.GetConfigurationSetting("wll_secret");
            SecurityAlgorithm = ExtensionMethods.GetConfigurationSetting("wll_securityalgorithm");
