...
{
    [Serializable]
    [KnownType(typeof(MaintenanceNSOMembersContactInfoViewModel))]
    public class MaintenanceNSOMembersContactInfoViewModel
    {
        public bool Editable { get; set; }

        public MaintenanceNSOMembersContactInfoViewModel(Resource resource = null)
        {
            if (resource != null)
            {
        ...
        [LocalizedDisplayName(typeof(MaintenanceNSOMembersLocalization), "Title_MailingAddress")]
        public string MailingAddress { get; set; }

        [LocalizedDisplayName(typeof(MaintenanceNSOMembersLocalization), "Title_MailingCity")]
        public string MailingCity { get; set; }

        [Editable(false)]
        [LocalizedDisplayName(typeof(MaintenanceNSOMembersLocalization), "Title_MailingProvinceId")]
        ...
        [LocalizedDisplayName(typeof(MaintenanceNSOMembersLocalization), "Title_EMailAddress")]
        public string EMailAddress { get; set; }

        [LocalizedDisplayName(typeof(MaintenanceNSOMembersLocalization), "Title_HometownCity")]
        public string HometownCity { get; set; }

        [LocalizedDisplayName(typeof(MaintenanceNSOMembersLocalization), "Title_HometownProvinceId")]
